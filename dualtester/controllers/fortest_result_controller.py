...
class ForTestResultController:
    ...
    Säilyttää vanhan MainWindow.handle_fortest_result()-toiminnan:
    - ohjaa tuloksen oikealle StationControllerille
    - näyttää virheet oikealla asemalla
    - käsittelee START/STOP-kuittaukset
    - välittää statusrekisterin StationControllerille
    - välittää tulosrekisterin StationControllerille
    """
