...
JIG_SEQUENCE_STATE_REGISTER_COUNT = 3
...
JIG_SEQUENCE_COMMAND_AUTO_PART_CHANGE = 5
...
JIG_SEQUENCE_ERROR_NONE = 0
JIG_SEQUENCE_ERROR_ABORTED = 1
JIG_SEQUENCE_ERROR_EMERGENCY_STOP = 2
JIG_SEQUENCE_ERROR_UNKNOWN_COMMAND = 3
JIG_SEQUENCE_ERROR_INVALID_STEP = 4
JIG_SEQUENCE_ERROR_PART_MISSING = 5